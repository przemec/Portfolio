...
<div class="project-wrapper">
  ...
  <p>
    ...
    in 2021; for this time I've been mainly coding new React components and refactoring old ones.
    I've also written my first test using Cypress. My biggest task was migrating whole app to
    styled-components.
  </p>
  ...
  <div class="project-preview">
    <img src="./preview-scheduling.png" alt="Project Preview" />
  </div>
</div>
